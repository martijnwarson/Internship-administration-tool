...
namespace WebApplication.Migrations
{
    ...
    [Migration("20200413115104_initial_create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication.Models.StringEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("WebApplication.Models.Period", b =>
                {
                    b.HasOne("WebApplication.Models.Internship", null)
                        .WithMany("Periods")
                        .HasForeignKey("InternshipId");
                });
